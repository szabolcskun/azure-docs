...
> [!NOTE]
> The new Azure Queue storage client library v12 for .NET SDK version is available, see [Quickstart: Azure Queue storage client library v12 for .NET](storage-quickstart-queues-dotnet.md).
